    ...
    <section class="w-full bg-center bg-cover min-h-screen relative" style="background-image: url('/servers.jpg');">
        ...
        <div class="relative z-10 max-w-6xl m-auto pt-[140px] px-4">
            ...
            <div v-else class="flex flex-col p-3 max-w-lg m-auto rounded-lg mt-6 bg-dark relative">
                ...
                <img src="https://cdn.discordapp.com/attachments/1130104696066015342/1130479487625216120/cut512x277.gif" class="rounded-lg" alt="Exile Rust Header Image">
                <div class="p-3">
...
<script setup>
    ...
    useSeoMeta({
        title: "The Sanctuary Servers List",
        ogTitle: 'The Sanctuary Servers List',
        description: 'Checkout The Sanctuary selection of servers list. To join the server, click the connect button and you will redirect to the server.',
        ogDescription: 'Checkout The Sanctuary selection of servers list. To join the server, click the connect button and you will redirect to the server.',
        ogImage: 'https://cdn.discordapp.com/attachments/1130104696066015342/1130479487625216120/cut512x277.gif',
        twitterCard: 'summary_large_image',
    });
    onMounted(() => {
        $fetch("https://api.battlemetrics.com/servers/22703430").then(result => {
